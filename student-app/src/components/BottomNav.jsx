...
const BottomNav = ({ view, setView, setSelectedSub }) => {
    ...
    return (
        <nav className="fixed bottom-4 left-4 right-4 h-16 bg-[#0c0c10]/80 backdrop-blur-xl border border-white/5 rounded-[24px] flex items-center justify-around px-4 z-50 shadow-2xl">
            {/* Quests Tab */}
            <div
                onClick={() => { playSound('click'); setView('home'); setSelectedSub(null); }}
            ...
            {/* Ranks Tab */}
            <div
                onClick={() => { playSound('click'); setView('ranks'); }}
            ...
            {/* Battle Button */}
            <div className="relative group cursor-pointer" onClick={() => { playSound('pop'); setView('battle'); }}>
            ...
            {/* Items Tab */}
            <div
                onClick={() => { playSound('click'); setView('items'); }}
